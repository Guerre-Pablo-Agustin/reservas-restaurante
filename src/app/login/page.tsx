...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="relative w-full max-w-4xl overflow-hidden bg-white rounded-lg shadow-lg h-screen lg:h-auto">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="block lg:hidden w-full p-8">
            ...
            <button
              onClick={toggleForm}
              className="mt-4 px-6 py-2 border-2 border-blue-600 rounded-full text-blue-600 hover:bg-blue-600 hover:text-white transition-colors duration-300"
            >
          ...
          <motion.div
            className="hidden  w-full lg:w-1/2 bg-blue-600 text-white p-8  flex-col lg:flex justify-center items-center text-center"
            animate={{ x: isLogin ? 0 : '-100%' }}
            transition={{ duration: 0.5, ease: 'easeInOut' }}
          >
